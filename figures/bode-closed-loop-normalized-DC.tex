...
\begin{tikzpicture}
  \begin{semilogxaxis} [
    ...
    \addplot  shell[thick,black, no marks, prefix=pgfshell_, id=bodeGc,] {octave --eval  "pkg load control; G=\Go; Gc = feedback(G, 1);  [mag,phi,w]=bode(Gc,{\wmin, \wmax}); disp(cat(2,w',mag2db(mag)))"};
  \end{semilogxaxis}
\end{tikzpicture}
