...
\begin{document}
     ...
     \nextgroupplot[xtick={0, \Tone, \TTone}]
      \addplot[\ycolor, thick, no marks] { \gainone*sin(deg(\wwone*t) + \psone) };
      \addplot[\ucolor,  no marks] { sin(deg(\wwone*t)) };

     \nextgroupplot[xtick={0, \Ttwo, \TTtwo}]
      \addplot[\ycolor, thick, no marks] { \gaintwo*sin(deg(\wwtwo*t) + \pstwo) };
      \addplot[\ucolor,  no marks] { sin(deg(\wwtwo*t)) };
 
     \nextgroupplot[xtick={0, \Tthree, \TTthree}]
      \addplot[\ycolor, thick, no marks] { \gainthree*sin(deg(\wwthree*t) + \psthree) };
      \addplot[\ucolor,  no marks] { sin(deg(\wwthree*t)) };

     \nextgroupplot[xtick={0, \Tfour, \TTfour}]
      \addplot[\ycolor, thick, no marks] { \gainfour*sin(deg(\wwfour*t) + \psfour) };
      \addplot[\ucolor,  no marks] { sin(deg(\wwfour*t)) };
