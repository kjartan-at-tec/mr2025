\documentclass[border={-10mm, 0mm, 4mm, 4mm}]{standalone}
...
\begin{tikzpicture}
  ...
  \begin{semilogxaxis} [
    ...
    \addplot  shell[thick, red!50!black, no marks, prefix=pgfshell_, id=bodelead,] {octave --eval  "pkg load control; G=tf([\alphad*\Td, 1],[\Td, 1]);  [mag,phi,w]=bode(G,{\wmin, \wmax}); disp(cat(2,w',mag2db(mag)))"};
  ...
  \end{semilogxaxis}
      ...
      \addplot  shell[thick, red!50!black, no marks, prefix=pgfshell_, id=bodelead,] {octave --eval  "pkg load control; G0=tf([\alphad*\Td, 1],[\Td, 1]);   [mag,phi,w]=bode(G0, {\wmin, \wmax}); disp(cat(2,w',phi))"};
