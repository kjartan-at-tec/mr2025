...
\label{sec:org2835578}
\begin{frame}[label={sec:orge770e99}]{The PID - practical form}
\definecolor{ppc}{rgb}{0.1,0.1,0.6}
\definecolor{iic}{rgb}{0.6,0.1,0.1}
...
\label{sec:orgaf85b07}

\begin{frame}[label={sec:orgc99c6a6}]{Analytical PID design}
\end{frame}
\begin{frame}[label={sec:org91487d1}]{Analytical PID design}
   \begin{center}
   \begin{tikzpicture}[node distance=22mm, block/.style={rectangle, draw, minimum width=15mm}, sumnode/.style={circle, draw, inner sep=2pt}]
  { 
  \node[coordinate] (input) {};
...
\begin{frame}[label={sec:org0c6e943}]{Analytical PID design - Solution}
\end{frame}
\begin{frame}[label={sec:orga47f82d}]{Analytical PID design - Solution}
...
\begin{frame}[label={sec:orgf1b7cf8}]{Analytic PID tuning - first-order with delay}
   \begin{center}
...
\begin{frame}[label={sec:org0dcae0c}]{Example}
   \begin{center}
   \begin{tikzpicture}[node distance=22mm, block/.style={rectangle, draw, minimum width=15mm}, sumnode/.style={circle, draw, inner sep=2pt}]
  { 
  \node[coordinate] (input) {};
...
\begin{frame}[label={sec:orga5b4797}]{The PID - practical aspects}
