...
\begin{frame}[label={sec:orgfc45c82}]{Step-invariant sampling (a.k.a ZOH sampling)}
...
\begin{frame}[label={sec:org4866cbc}]{Why is step-invariant sampling a good idea?}
