...
\label{sec:org2f935f0}
\begin{frame}[label={sec:org44016c9}]{State feedback with reconstructed states}
\end{frame}

\begin{frame}[label={sec:orgbac2dad}]{State feedback with reconstructed states}
\begin{center}
\includegraphics[width=0.9\linewidth]{../../figures/fig-apollo}
\end{center}
\end{frame}

\begin{frame}[label={sec:org2d58208}]{State feedback}
Given
 \begin{equation}
 \begin{split}
  \dot{x} &= A x + B u\\
