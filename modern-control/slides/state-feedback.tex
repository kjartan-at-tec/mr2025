...
\begin{frame}[label={sec:orgbe4da78}]{State variables}
\begin{columns}
...
\begin{frame}[label={sec:orgc7b735e}]{State-space model}
...
\begin{frame}[label={sec:org4b99922}]{Linear state feedback}
\begin{columns}
...
\begin{frame}[label={sec:org5228810}]{Linear state feedback}
\small
...
\begin{frame}[label={sec:org4d84236}]{Where to place the closed-loop poles}
\begin{columns}
...
\begin{frame}[label={sec:orgab40433}]{Determining the state feedback gain}
