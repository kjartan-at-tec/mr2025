...
\section{Intro}
\label{sec:orgbd1e666}
\begin{frame}[label={sec:org2751a29}]{A complicated process}
\begin{columns}
...
\begin{frame}[label={sec:org751e871}]{System identification}
\small
...
\begin{frame}[label={sec:org490de77}]{The shift operator \(\shift\)}
...
\begin{frame}[label={sec:orgb5a828e}]{The Auto-Regressive with eXogenous input (ARX) model}
\begin{center}
...
\begin{frame}[label={sec:org67debc5}]{First-order ARX model with one delay}
\small
...
\begin{frame}[label={sec:orga46ad0e}]{Parameter estimation - Least squares}
...
\begin{frame}[label={sec:org14c898d}]{Parameter estimation - Least squares}
...
\begin{frame}[label={sec:orgd45f810}]{Parameter estimation - Least squares}
\begin{enumerate}
\setcounter{enumi}{1}
...
\begin{frame}[label={sec:org38f4275}]{The problem with least squares}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{align*}
...
\begin{frame}[label={sec:orgb47fa3d}]{More robust: The Huber loss function}
\begin{columns}
\begin{column}{0.4\columnwidth}
...
\begin{frame}[label={sec:org79c3a95}]{First-order ARX model without delay}
\begin{center}
...
\begin{frame}[label={sec:org2c10269}]{The ARX model}
\[ A(\shift) y(k) = B(\shift)u(k) + e(k+n)\]
